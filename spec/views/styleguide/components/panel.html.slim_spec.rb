...
RSpec.describe "styleguide/components/panel.html.slim", type: :view do

  describe "GET #a-z" do
    before(:each) do
      # you'll need to specify both the template and the layout explicitly
      render template: 'styleguide/components/panel', layout: 'layouts/sub_layout'
    end
    ...
    it "rendered page partials" do
      expect(response.body).to render_template(partial: "_panel")
    end
